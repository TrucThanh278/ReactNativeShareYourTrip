...
// const ProfileStack = () => (
//   <Stack.Navigator>
//     <Stack.Screen name="UserProfile" component={Profile} options={{ title: "Hồ Sơ Của Tôi" }} />
...
// const HomeStack = () => (
//   <Stack.Navigator>
//     <Stack.Screen name="HomeScreen" component={Post} options={{ title: "Trang Chủ" }} />
//     <Stack.Screen name="ProfileNavigator" component={ProfileNavigator} options={{ title: "Hồ Sơ" }} />
//     <Stack.Screen name="CreatePost" component={CreatePost} options={{ title: "Tạo Bài Đăng" }} />
//     <Stack.Screen name="AddImage" component={AddImage} options={{ title: "Bài Đăng Ảnh" }} />
//     <Stack.Screen name="CreateHashtagPost" component={CreateHashtagPostScreen} options={{ title: "Tạo Hashtag Post" }} />
...
//   <Stack.Navigator>
//     <Stack.Screen name="AdminProfile" component={AdminHome} options={{ title: "Hồ Sơ Admin" }} />
//     <Stack.Screen name="UpdateProfile" component={UpdateProfile} options={{ title: "Cập Nhật Hồ Sơ" }} />
//   </Stack.Navigator>
// );
...
//   <Stack.Navigator>
//     <Stack.Screen name="Manage" component={ManageReports} options={{ title: "Quản Lý Báo Cáo" }} />
//   </Stack.Navigator>
// );
