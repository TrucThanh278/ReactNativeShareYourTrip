...
import { View, Text, FlatList, TouchableOpacity, Alert, Image, StyleSheet, TextInput } from 'react-native';
...
const defaultAvatar = require('../../components/Users/assets/images/default_avatar.jpg'); // Path to default avatar image
...
const Chat = () => {
  ...
  const renderAvatar = (item) => {
    if (item.avatar) {
      ...
      return <Image source={defaultAvatar} style={styles.avatar} />;
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => handleChat(item)} style={styles.userItem}>
            {renderAvatar(item)}
