...
//             setIsCurrentUser(loggedInUser.id === user.id);
//         }
//     }, [loggedInUser, user]);

//     const pickAvatar = async () => {
//         // Thêm logic chọn avatar
//     };

//     const pickCoverPhoto = async () => {
//         // Thêm logic chọn ảnh bìa
//     };
...
//     // Render component ProfileUser nếu user đang xem là user hiện tại
//     if (isCurrentUser) {
//         return (
//             <ScrollView style={[MyStyles.container, MyStyles.margin]}>
//                 <Profile />
...
//         );
//     } else {
//         // Render component ProfileUser nếu user đang xem không phải là user hiện tại
//         return (
//             <ScrollView style={[MyStyles.container, MyStyles.margin]}>
//                 <View>
//                     <TouchableOpacity onPress={pickCoverPhoto}>
//                         <Image source={user.coverPhoto ? { uri: user.coverPhoto } : require("./assets/images/default_cover.jpg")} style={styles.coverPhoto} />
//                     </TouchableOpacity>
//                     <View style={[styles.position, styles.margin_avatar]}>
//                         <TouchableOpacity onPress={pickAvatar}>
//                             {user.avatar ? (
...
//                         <Text style={styles.text}>Phone: {user.phone_number}</Text>
//                         <Button icon="message" buttonColor="rgb(79, 133, 13)" mode="contained">Chat</Button>
//                         <Button icon="alert-circle">Report</Button>
//                         <View style={styles.collections}>
//                             <Text style={styles.sectionTitle}>Personal Collections</Text>
//                             <ScrollView horizontal style={{ height: 150 }}>
//                                 {/* Hiển thị bộ sưu tập cá nhân */}
//                             </ScrollView>
//                         </View>
//                     </View>
//                     <View style={styles.stats}>
